...
class TestProductRoutes(TestCase):
    ...
    def test_get_product_not_found(self):
        """It should return a status of 404 when product is not found"""
        invalid_id = 0
    ...
    def test_get_by_name(self):
        """It should GET all products with NAME equal to query"""
        products = self._create_products(5)
    ...
    def get_by_category(self):
        """It should GET all products with CATEGORY equal to query"""
    ...
    def test_query_by_availability(self):
        """It should GET all products with AVAILABILITY equal to query"""
        products = self._create_products(10)
